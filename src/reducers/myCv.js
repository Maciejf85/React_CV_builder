const initialState = [
  {
    ...
    interests: [
      {
        id: 1,
        description: 'Programowanie, fotografia, elektronika, mikroprocesory, sztuki walki',
      },
    ],
    experience: [
      {
  ...
  {
    currentItem: {
      id: 'c7f9ae308a6083ec88e5d93486fa71fe',
      title: 'Moje CV_2',
      date: 1569430604,
    },
    education: [
    ...
    skills: [
      {
        id: 1,
        description: 'Języki programowania : JavaScript: ES6',
      },
      {
        id: 2,
        description: 'Frameworki : React/Redux, jQuery',
      },
    ],
    languages: [
      {
